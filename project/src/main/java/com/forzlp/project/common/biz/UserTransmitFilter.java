...
import static com.forzlp.project.common.constant.RedisConstant.USER_TOKEN_KEY;
import static com.forzlp.project.common.convention.errorcode.BaseErrorCode.USER_NOT_LOGIN;
...
public class UserTransmitFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (Boolean.FALSE.equals(stringRedisTemplate.hasKey(USER_TOKEN_KEY + token))) {
            ...
            // 转发请求
            servletRequest.getRequestDispatcher("/myPError").forward(servletRequest,servletResponse);
        }
        try {
