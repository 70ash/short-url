...
public class GroupController {
    ...
    // 查看短链接分组
    @GetMapping("/list")
    public Result<List<ListGroupRespDTO>> listGroup(@RequestParam Integer pageSize, @RequestParam Integer pageNum) {
        List<ListGroupRespDTO> list = groupService.listGroup(pageSize, pageNum);
